...
loader_start:
	...
	alloc $ROM_DELTA_SIZE - 3
	
 loader_start2:	
	ld sp, loader_end + $TEMPLATE_SIZE + 24
	or a, a
	jr z, loader_l1
	ld b, a
...
loader_exec:
	ld hl, loader_end
	ld de, $LOADER_ADDR + $ROM_DELTA_SIZE
	ld bc, $TEMPLATE_SIZE
	call _ldir	
	call loader_page_rst	
	ld hl, 0x1200
	ld bc, $ROM_DELTA_SIZE
	ld de, $LOADER_ADDR
	ldir	
	ld hl, 0xffff
	ld sp, $LOADER_ADDR + $ROM_DELTA_SIZE + $TEMPLATE_SIZE + 24
	;jp $LOADER_ADDR + $ROM_DELTA_SIZE
	jp $LOADER_ADDR
loader_end: