...
record_body_start:
	...
	defw	$PROG_ADDR + 1807 ;src address in page	
...
;-----------------------------
	...
	defw	$PROG_ADDR + 3027 ;src address in page
...
;-----------------------------
	...
	defw	$PROG_ADDR + 4247 ;src address in page
...
;-----------------------------
	...
	defw	$PROG_ADDR + 5467 ;src address in page
		
	defb 1 ;record countld sp, 65000	
